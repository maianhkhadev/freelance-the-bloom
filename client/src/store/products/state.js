  ...
  products: [
    {
      ...
      price: 180000,
      thumbnail: {
        src: require('@/assets/images/stores/products/im-018.png'),
        alt: 'The Bloom'
      }
    }, {
      collection: '004',
      ...
      content: 'Củ gừng ta nhỏ mà đậm vị và thơm nồng được trồng sạch từ vườn Đạ Tẻh Lâm Đồng, ngào với đường thốt nốt để cả vị lẫn hương thêm ngọt. Gừng cay ấm, ta chiêu thêm chút trà, cả chầu hàn huyên sẽ đượm.',
      price: 125000,
      thumbnail: {
      ...
      content: 'Những trái mơ và mận tam hoa Mộc Châu trồng sạch, chín tới thoang thoảng hương núi rừng. Mơ mận quện vào nhau tròn trịa, dẻo dẻo, xinh xinh, không cần cho đường vẫn ngọt thanh, lẫn với vị chua nhẹ, cứ muốn nhâm nhi mãi',
      price: 150000,
      thumbnail: {
      ...
      collection: '003',
      code: '060',
      name: 'Bánh chưng nhân thịt lợn thảo mộc',
      content: 'Bánh chưng có nhân thịt lợn nuôi thảo mộc thơm lừng, thịt chắc và ngọt; xắn một miếng cảm nhận được liền độ dẻo của gạo nếp quýt, độ thơm của lá dong, vị cay nồng của hạt tiêu Bắc, vị béo của nhân thịt ba chỉ, vị bùi của đỗ xanh tự đãi, hòa lẫn trong sắc bánh xanh mướt mát.. cái ngon của bánh  là cái ngon của vị lành từ vỏ cho đến nhân. Còn cái đẹp là từ kĩ thuật gói bánh lành nghề: chỉ dùng tay  không dùng khuôn, vậy mà sau khi luộc chín, từng chiếc bánh vẫn “vuông thành sắc cạnh” một cách đều đặn. Bánh để được 5 ngày ở nhiệt độ thường, 1 tháng trong ngăn mát, từ 2-3 tháng trong tủ đông.',
      price: 170000,
      thumbnail: {
      ...
      collection: '003',
      code: '061',
      name: 'Bánh chưng nhân thịt gà đồi',
      content: 'Nếu muốn thử chút vị lạ, hoặc đang phải kiêng các loại thịt có lượng mỡ cao, nên thử một miếng bánh chưng nhân thịt gà đồi để cảm nhận được vị ngọt, thơm ngon của thịt gà được nuôi khỏe mạnh: gà có da mềm nhưng không nát, thịt mềm và chắc, lẫn với vị cay dịu, thơm nồng của hạt tiêu Bắc và hành củ, đó là chưa kể khi nhân quyện với vỏ bánh bùi bùi vị đỗ xanh và gạo nếp quýt. Bánh gói bằng tay, không dùng khuôn vậy mà sau khi luộc chín, từng chiếc bánh vẫn “vuông thành sắc cạnh” một cách đều đặn. Bánh để được 5 ngày ở nhiệt độ thường, 1 tháng trong ngăn mát, từ 2-3 tháng trong tủ đông.',
      price: 180000,
      thumbnail: {
        src: require('@/assets/images/stores/products/im-039.png'),
        alt: 'The Bloom'
      ...
      content: 'Nhân bánh chỉ tuyền đỗ xanh, nhưng phải là loại có xuất xứ từ những vùng quê chuyên trồng đỗ. Được đãi thủ công, khi nấu xong đỗ bở tơi, vàng óng và cho vị vừa béo, vừa bùi, quyện vị cay dịu, thơm nồng của hạt tiêu và hành củ, cho vị tròn trịa, mà thanh tao. Bánh gói bằng tay, không dùng khuôn vậy mà sau khi luộc chín, từng chiếc bánh vẫn “vuông thành sắc cạnh” một cách đều đặn. Bánh để được 5 ngày ở nhiệt độ thường, 1 tháng trong ngăn mát, từ 2-3 tháng trong tủ đông.',
      price: 140000,
      thumbnail: {
        src: require('@/assets/images/stores/products/im-039.png'),
        alt: 'The Bloom'
      ...
      content: 'Bánh chưng từ những nghệ nhân Bắc Ninh trải qua mấy kỳ tuyển lựa: nếp cái hoa vàng phải hạt to đều và thơm ngát, đậu xanh chắc hạt, thịt ba chỉ đều thớ, tất cả từ nguồn nuôi trồng sạch thuận tự nhiên. Rồi phải chọn lá dong sạch và sợi giang dẻo để gói bánh thật vuông, thật chắc, đem luộc thật rền.',
      price: 130000,
      thumbnail: {
        src: require('@/assets/images/stores/products/im-039.png'),
        alt: 'The Bloom'
      ...
      code: '036',
      name: 'Giò thủ 500gr',
      content: 'Giò thủ bếp nhà tự gói bằng thịt heo nuôi sạch và tiêu hồng Phú Quốc. Giò buộc bằng lạt tre mộc mạc nhưng chắc nịch, tất thảy được nén chặt thủ công khi nguyên liệu còn nóng để kết chặt vào nhau. Cắn một miếng thấy sụn giòn giòn lẫn với vị tiêu cay và nấm mèo sần sật, thơm lựng!',
      price: 160000,
      thumbnail: {
