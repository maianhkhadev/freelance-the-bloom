    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-xl-6 mx-auto text-center">
          ...
          <div class="content">
            <p>Tạo giỏ quà Tết theo cách của bạn</p>
          </div>
          <div class="row tabs">
            <div class="col">
        ...
        <div class="col-xl-12">
          <div class="title text-center mt-4 mb-5" style="font-size: 1.875rem;">Phụ kiện giỏ quà Tết</div>
...
<style lang="scss" scoped>
  ...
  .section .container {
    ...
    .tab-link {
      ...
      &:hover {
        border-bottom: 0.125rem solid #dc4551;
      }
